...
import 'package:aba_app/transfer_to_other_aba.dart'; 
import 'package:firebase_auth/firebase_auth.dart';

class ABATransferPage extends StatefulWidget {
  final User user;
  const ABATransferPage({super.key, required this.user});
                ...
                return InkWell(
                  onTap: () {
                    Navigator.push(
                              context,
                              MaterialPageRoute(
                                builder: (context) => TransferToOtherABAPage(user: widget.user),
                              ),
                            );
                  },
